            ...
            <nav className="fixed top-0 w-full z-50 px-6 md:px-12 py-8 flex justify-between items-center bg-background/80 backdrop-blur-md border-b border-black/5">
                ...
                <div className="flex items-center gap-10">
                    <div className="hidden md:flex gap-10 text-[11px] font-bold tracking-widest uppercase">
                        <Link href="/about" className="border-b-2 border-black pb-1">ABOUT</Link>
                    ...
                    <Link href="/feed" className="bg-black text-white px-8 py-3 rounded-full text-[11px] font-bold tracking-widest uppercase hover:bg-black/80 transition-all">
                        GET STARTED
                    </Link>
                </div>
            </nav>
